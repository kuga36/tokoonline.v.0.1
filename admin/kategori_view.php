       ...
       <div class="container-fluid">
        <div class="row-fluid">
            <div id="" class="brand span12">
                    <h1 class="">kategori Management</h1>
            </div>
            <div class="span3">
                <div id="form_input" class="">
                <?php if(!empty($kategori)){ echo var_dump($kategori);}?>
                <?php echo form_open('kategori/submit',array('id'=>'addform','class'=>'form form-vertical')); ?>
                    
                    <input type="hidden" value='' id="idkategori" name="idkategori">
                    
                    <div class="control-group">
                            <?php echo form_label('namakategori : ','namakategori',array('class'=>'control-label')); ?>
                            <div class="controls">
                                <?php echo form_input('namakategori','','id="namakategori"'); ?>
                            </div>
                    </div>
...
<script>
    $(document).ready(function(){
        ...
        oTable=$('#datatables').dataTable({
            "sAjaxSource":"<?php echo base_url();?>kategori/getdatatables",
            "sScrollY": "300px",
            "sServerMethod": "POST",
            "bServerSide": true,
            "bJQueryUI": true,
            ...
            "aoColumns": [
                ...
                { "sClass": "idkategori","sName": "idkategori","sWidth": "50px", "aTargets": [0] } ,
                { "sClass": "namakategori", "sName": "namakategori", "sWidth": "80px", "aTargets": [ 1 ] },
        ...
        function save(idkategori){
            ...
            $(this).ready(function(){
                $.ajax({
                    url:"<?php echo base_url();?>kategori/submit",
                    data:dataform,
                    type:"POST",
                    success:function(){
        ...
        $('button.edit').live("click",function(e){
            ...
            $(this).ready(function(){
                    $.ajax({
                        url:"<?php echo base_url();?>kategori/get/"+id,
                        type:"get",
                        dataType:"json",
